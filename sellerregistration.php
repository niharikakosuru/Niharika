...
<body background="greenapple.jpg";>
      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-success class">
          <div class="panel-heading">
              <h2 class="panel-title-center"> <center>Seller Registration</center> </h2>
          </div>
          <div class="panel-body">
				<form  id="myform" method="post" action="sellersignup.php"> 
				...
				<div class="form-group">
					...
					<button type="submit" id="form_button" value="button" class="btn btn-default" onclick="form_send()"  >submit</button>
				</form>
			</div>
			<div class="col-sm-4">				
			</div>
